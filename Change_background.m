...
while true 
    ...
    b=b+1; %counting how many background there is, excluding the ones that were trace again 
...
%give one mean value per stack, witch means that the mean value
%for every ROI is calculated
